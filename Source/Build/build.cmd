...
@set net4_asms=C:\Program Files (x86)\Reference Assemblies\Microsoft\Framework\.NETFramework\v4.7.2
...
"%net45_tools%\msbuild.exe" ..\cswscript\cswscript.csproj /p:AssemblyName=csws /p:TargetFrameworkVersion=v4.7.2  /p:configuration=Release;Platform="AnyCPU" /p:OutDir=bin\Distro /p:DefineConstants="net4;net45" %common_msbuild_params%
move ..\cswscript\bin\Distro\csws.exe ..\Build\csws.exe
ECHO ------------ >> ..\Build\build.log

ECHO Building csws32.exe: >> ..\Build\build.log
"%net45_tools%\msbuild.exe" ..\cscscript\cscscript.csproj /p:AssemblyName=csws /p:TargetFrameworkVersion=v4.7.2  /p:PlatformTarget=x86 /p:configuration=Release;Platform="AnyCPU" /p:OutDir=bin\Distro /p:DefineConstants="net4;net45" %common_msbuild_params%
...
"%net45_tools%\msbuild.exe" ..\css_config\css_config.csproj /p:TargetFrameworkVersion=v4.7.2  /p:configuration=Release;Platform="AnyCPU" /p:OutDir=bin\Distro %common_msbuild_params%
